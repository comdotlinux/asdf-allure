...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for allure.
...
# NOTE: You might want to remove this if allure is not hosted on GitHub releases.
